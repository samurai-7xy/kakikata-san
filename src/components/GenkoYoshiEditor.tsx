...
const GenkoYoshiEditor: React.FC = () => {
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            setScale(containerWidth < genkoWidth ? containerWidth / genkoWidth : 1.0);
        };
    ...
    const pageCount = useMemo(() => Math.max(1, Math.ceil(text.length / charsPerPage)), [text.length]);
    ...
    const placeholderText = useMemo(() => rubyMode === "hiragana"
        ? "ここに ぶんしょうを にゅうりょく してください..."
        : "ここに文章を入力してください...", [rubyMode]);
